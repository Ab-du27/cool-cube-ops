...
const dict = {
  ku: {
    ...
    month: "مانگ",
    calculator: "ژمێرەر",
    calcHint: "ژمارەی ڕیز بنووسە بۆ زانینی بڕی پارە",
    result: "ئەنجام",
    debts: "قەرزەکان",
    sortByName: "ڕیزکردن بە ناو",
    sortByDate: "ڕیزکردن بە بەروار",
    employeesAccounts: "هەژمارەکانی کارمەندان",
    newEmployee: "کارمەندی نوێ",
    create: "دروستکردن",
    accountCreated: "هەژمار دروستکرا",
    changePassword: "گۆڕینی وشەی نهێنی",
    autoRelease: "ئازادکردنی خۆکاری ڕیزەکان",
    autoReleaseHours: "دوای چەند کاتژمێر ئازاد بکرێن",
    releaseNow: "ئێستا هەموو ڕیزەکان ئازاد بکە",
    rowsReleased: "ڕیزەکان ئازاد کران",
    checklistAutoReset: "نوێکردنەوەی خۆکاری لیستی پشکنین (هەفتانە)",
    resetChecklist: "نوێکردنەوەی لیستی پشکنین ئێستا",
    checklistReset: "لیستی پشکنین نوێکرایەوە",
    onlyAdminCreates: "تەنها بەڕێوەبەر هەژمار دروست دەکات",
  ...
  ar: {
    ...
    month: "الشهر",
    calculator: "الحاسبة",
    calcHint: "اكتب عدد الصفوف لمعرفة المبلغ",
    result: "النتيجة",
    debts: "الديون",
    sortByName: "ترتيب حسب الاسم",
    sortByDate: "ترتيب حسب التاريخ",
    employeesAccounts: "حسابات الموظفين",
    newEmployee: "موظف جديد",
    create: "إنشاء",
    accountCreated: "تم إنشاء الحساب",
    changePassword: "تغيير كلمة المرور",
    autoRelease: "تحرير الصفوف تلقائياً",
    autoReleaseHours: "التحرير بعد كم ساعة",
    releaseNow: "حرر جميع الصفوف الآن",
    rowsReleased: "تم تحرير الصفوف",
    checklistAutoReset: "تصفير قائمة الفحص تلقائياً (أسبوعياً)",
    resetChecklist: "تصفير قائمة الفحص الآن",
    checklistReset: "تم تصفير قائمة الفحص",
    onlyAdminCreates: "المدير فقط ينشئ الحسابات",
